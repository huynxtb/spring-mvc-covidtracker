        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="form">
                    ...
                    <form class="form-validate form-horizontal" role="form" action="/support-register" method="post"
                        ...
                        <div class="form-group ">
                            <label class="control-label col-lg-2">Family Circumstances<span
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-8">
                                <input id="charity-address" class=" form-control" name="address"
                                       cssStyle="width: 94%;display: inline" onfocus="enterLocation()"
                                       required="required"/>

                                <span><img onclick="chooseLocation()" class="buttonSearch"
                                           src="/template/web/img/icons/choose.png"/></span>
                                <style> .buttonSearch:hover {
                                    cursor: pointer
                                } </style>
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-8">
                                ...
                                <input style="color: #0E993C" id="btnSign" class="btn btn-warning notika-btn-warning"
                                       type="submit" value="ASSIGN"/>
                                <button style="color: #0E993C" type="reset" class="btn btn-warning notika-btn-warning">
                                    Reset
                                </button>
...
<img id="yourLocation" src="/template/web/img/icons/geolocation.png" style="display: none" width="40px" height="40px"
     onclick="currentLocation()"/>
<style> #yourLocation:hover {
    cursor: pointer
} </style>
