...
public class WheelChairEntity {
    ...
    @Column(name = "wName", columnDefinition = "TEXT")
    private String name;

    @NotNull(message = "Phone cant be null")
    @Column(name = "wPhone", columnDefinition = "TEXT")
    private String phone;

    @NotNull(message = "Address cant be null")
    @Column(name = "wAddress", columnDefinition = "TEXT")
    private String address;

    @NotNull(message = "Detail cant be null")
    @Column(name = "wDetail",columnDefinition = "TEXT")
    ...
    @Column(name = "wBase64",columnDefinition = "TEXT")
